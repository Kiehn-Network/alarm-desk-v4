    ...
    return {
      ...
      stats: {
       ...
       recent: recents.map((r: any) => ({
        ...
        start: r.created_at ? new Date(r.created_at).toLocaleString("de-DE", { timeZone: "Europe/Berlin", day: "2-digit", month: "2-digit", hour: "2-digit", minute: "2-digit" }) : "–",
        ende: r.abgeschlossen_am ? new Date(r.abgeschlossen_am).toLocaleString("de-DE", { timeZone: "Europe/Berlin", day: "2-digit", month: "2-digit", hour: "2-digit", minute: "2-digit" }) : "–",
