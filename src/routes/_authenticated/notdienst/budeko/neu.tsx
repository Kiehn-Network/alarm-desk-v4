...
import { createBudekoBericht } from "@/lib/budeko.functions";
...
export const Route = createFileRoute("/_authenticated/notdienst/budeko/neu")({
...
function NeuerBericht() {
  ...
  const createFn = useServerFn(createBudekoBericht);
  ...
  const mut = useMutation({
    ...
    onSuccess: () => {
      ...
      navigate({ to: "/notdienst/budeko/nachbearbeitung" });
    },
    ...
    <div className="max-w-3xl">
      ...
      >
        ...
        <Section title="Zeitangaben:" cols={3}>
          ...
          <Field label="Name der Bereitschaft">
