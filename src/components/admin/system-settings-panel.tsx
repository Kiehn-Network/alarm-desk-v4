...
import { getAppSettings, updateAppSettings, updateFahrerZeitenConfig, updatePdfZeitenConfig, updateZentraleAdresse, updateBerichtVersandMode } from "@/lib/settings.functions";
